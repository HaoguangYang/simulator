...
//     version 1.5.0
//     from Assets/Scripts/Controllers/SimulatorControls.inputactions
//
...
public partial class @SimulatorControls: IInputActionCollection2, IDisposable
{
    ...
    private List<ISimulatorActions> m_SimulatorActionsCallbackInterfaces = new List<ISimulatorActions>();
    ...
    public struct SimulatorActions
    {
        ...
        public void AddCallbacks(ISimulatorActions instance)
        {
            if (instance == null || m_Wrapper.m_SimulatorActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_SimulatorActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ISimulatorActions instance)
        {
            @ToggleNPCS.started -= instance.OnToggleNPCS;
            @ToggleNPCS.performed -= instance.OnToggleNPCS;
            @ToggleNPCS.canceled -= instance.OnToggleNPCS;
        ...
        public void RemoveCallbacks(ISimulatorActions instance)
        {
            if (m_Wrapper.m_SimulatorActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ISimulatorActions instance)
        {
            foreach (var item in m_Wrapper.m_SimulatorActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SimulatorActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
