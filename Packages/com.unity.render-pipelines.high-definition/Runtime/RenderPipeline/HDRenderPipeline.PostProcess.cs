...
namespace UnityEngine.Rendering.HighDefinition
{
    public partial class HDRenderPipeline
    {
        ...
        static void DoHistogramBasedExposure(DynamicExposureData data, CommandBuffer cmd)
        {
            ...
            if (data.camera.ExposureAdaptationLocked)
            {
                data.exposureVariants[2] = (int)AdaptationMode.Fixed;
                data.camera.ResetExposureAdaptationLock();
            }
            // ===
