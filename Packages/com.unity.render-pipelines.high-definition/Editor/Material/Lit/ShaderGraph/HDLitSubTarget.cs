...
namespace UnityEditor.Rendering.HighDefinition.ShaderGraph
{
    sealed partial class HDLitSubTarget : LightingSubTarget, ILegacyTarget, IRequiresData<HDLitData>
    {
        ...
        protected override SubShaderDescriptor GetSubShaderDescriptor()
        {
            ...
            // === LGSVL (Generate sensor passes for HDLitSubTarget)
            descriptor.passes.Add(SVLShaderPasses.GenerateLidar());
            descriptor.passes.Add(SVLShaderPasses.GenerateSegmentation());
            descriptor.passes.Add(SVLShaderPasses.GenerateDepth());
            // ===
